...
import { MilestoneWithSkills, TRoadmap } from '@jobie/roadmap/types';
import {
  Box,
  CircularProgress,
  Stack,
...
export const Roadmap = () => {
  ...
  } = useDataFetch<MilestoneWithSkills[]>(() =>
  ...
  useEffect(() => {
    const checkAndRedirect = async () => {
      const data = await roadmapCalibrationApi.get<TRoadmap>('/');
      if (!data.data?.milestonesWithSkills?.length) {
